...
PHONOLOGY_LUT = {
    C_HIEUT: {
        O_HIEUT: (C_NONE, O_HIEUT, ''),
        O_GIYEOK: (C_NONE, O_KIEUK, "12항"),
        O_SSANGGIYEOK: (C_NONE, O_SSANGGIYEOK, ''),
        O_NIEUN: (C_NIEUN, O_NIEUN, "12항"),
        O_DIGEUT: (C_NONE, O_TIEUT, "12항"),
        O_SSANGDIGEUT: (C_NONE, O_SSANGDIGEUT, ''),
        O_RIEUL: (C_NONE, O_RIEUL, ''),
        O_MIEUM: (C_NONE, O_MIEUM, ''),
        O_BIEUP: (C_NONE, O_BIEUP, ''),
        O_SSANGBIEUP: (C_NONE, O_SSANGBIEUP, ''),
        O_SIOT: (C_NONE, O_SSANGSIOT, "12항"),
        O_SSANGSIOT: (C_NONE, O_SSANGSIOT, ''),
        O_JIEUT: (C_NONE, O_CHIEUT, "12항"),
        O_SSANGJIEUT: (C_NONE, O_SSANGJIEUT, ''),
        O_CHIEUT: (C_NONE, O_CHIEUT, ''),
        O_KIEUK: (C_NONE, O_KIEUK, ''),
        O_TIEUT: (C_NONE, O_TIEUT, ''),
        O_PIEUP: (C_NONE, O_PIEUP, ''),
        O_EOW: (C_DIGEUT, O_EOW, ''),
    },
    C_GIYEOK: {
    ...
    C_NIEUN_HIEUT: {
        O_HIEUT: (C_NIEUN, O_HIEUT, ''),
        O_GIYEOK: (C_NIEUN, O_KIEUK, "12항"),
        O_SSANGGIYEOK: (C_NIEUN, O_SSANGGIYEOK, ''),
        O_NIEUN: (C_NIEUN, O_NIEUN, "12항"),
        O_DIGEUT: (C_NIEUN, O_TIEUT, "12항"),
        O_SSANGDIGEUT: (C_NIEUN, O_SSANGDIGEUT, ''),
        O_RIEUL: (C_RIEUL, O_RIEUL, ''),
        O_MIEUM: (C_NIEUN, O_MIEUM, ''),
        O_BIEUP: (C_NIEUN, O_BIEUP, ''),
        O_SSANGBIEUP: (C_NIEUN, O_SSANGBIEUP, ''),
        O_SIOT: (C_NIEUN, O_SSANGSIOT, "12항"),
        O_SSANGSIOT: (C_NIEUN, O_SSANGSIOT, ''),
        O_JIEUT: (C_NIEUN, O_CHIEUT, "12항"),
        O_SSANGJIEUT: (C_NIEUN, O_SSANGJIEUT, ''),
        O_CHIEUT: (C_NIEUN, O_CHIEUT, ''),
        O_KIEUK: (C_NIEUN, O_KIEUK, ''),
        O_TIEUT: (C_NIEUN, O_TIEUT, ''),
        O_PIEUP: (C_NIEUN, O_PIEUP, ''),
        O_EOW: (C_NIEUN, O_EOW, ''),
    },
    C_DIGEUT: {
    ...
    C_RIEUL_HIEUT: {
        ...
        O_SSANGGIYEOK: (C_RIEUL, O_SSANGGIYEOK, ''),
        O_NIEUN: (C_RIEUL, O_RIEUL, "12항/20항"),
        O_DIGEUT: (C_RIEUL, O_TIEUT, "12항"),
        O_SSANGDIGEUT: (C_RIEUL, O_SSANGDIGEUT, ''),
        O_RIEUL: (C_RIEUL, O_RIEUL, ''),
        O_MIEUM: (C_RIEUL, O_MIEUM, ''),
        O_BIEUP: (C_RIEUL, O_BIEUP, ''),
        O_SSANGBIEUP: (C_RIEUL, O_SSANGBIEUP, ''),
        O_SIOT: (C_RIEUL, O_SSANGSIOT, "12항"),
        O_SSANGSIOT: (C_RIEUL, O_SSANGSIOT, ''),
        O_JIEUT: (C_RIEUL, O_CHIEUT, "12항"),
        O_SSANGJIEUT: (C_RIEUL, O_SSANGJIEUT, ''),
        O_CHIEUT: (C_RIEUL, O_CHIEUT, ''),
        O_KIEUK: (C_RIEUL, O_KIEUK, ''),
        O_TIEUT: (C_RIEUL, O_TIEUT, ''),
        O_PIEUP: (C_RIEUL, O_PIEUP, ''),
        O_EOW: (C_RIEUL, O_EOW, ''),
    },
    C_MIEUM: {
    ...
    C_BIEUP_SIOT: {
        ...
        O_PIEUP: (C_BIEUP, O_PIEUP, ''),
        O_EOW: (C_BIEUP, O_EOW, "10항"),
    },
    C_SIOT: {
        O_HIEUT: (C_NONE, O_TIEUT, ''),
