...
class TestPhoneNorm25(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    # ================================================================================
    # 제25항 어간 받침 ㄼ, ㄾ 뒤에 결합되는 어미의 첫소리 ㄱ, ㄷ, ㅅ, ㅈ은
    #        된소리로 발음 (겹받침 어간 뒤 경음화)
    # ================================================================================
    def test_norm25_words(self):
        """개별 단어 검증: 제25항 본항 (어간 받침 ㄼ·ㄾ 뒤 경음화)"""
        cases = {
            "넓게": "널께",
            "핥다": "할따",
            "훑소": "훌쏘",
    ...
    def test_norm25_sentences(self):
        """통합 엔진 검증: 제25항 본항 포함 문장"""
        sentence = self._strip_punctuation("고양이가 접시를 핥다 말고 물러나자, 나는 떫지 않은 감을 고르고 마당을 넓게 쓸었다.")
        expected = "고양이가 접씨를 할따 말고 물러나자 나는 떨찌 아는 가믈 고르고 마당을 널께 쓰럳따"
